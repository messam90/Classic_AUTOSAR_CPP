...
private:
	uint8 PduId;
	Lin::Lin_FramePidType Pid;
	Lin::Lin_FrameCsModelType Cs;
	Lin::Lin_FrameResponseType Drc;
	Lin::Lin_FrameDlType Dl;
public:
	UncoditionalFrame_t(const UncoditionalFrame_t& UCF){
		PduId = UCF.PduId;
		Pid = UCF.Pid;
		Dl = UCF.Dl;
		Cs = UCF.Cs;
	...
	UncoditionalFrame_t(uint8 PduId, Lin::Lin_FramePidType PID, Lin::Lin_FrameDlType Length, Lin::Lin_FrameCsModelType Cs, Lin::Lin_FrameResponseType Drc){
		this->PduId = PduId;
		this->Pid = PID;
		this->Dl = Length;
		this->Cs = Cs;
